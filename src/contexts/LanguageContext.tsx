...
const translations: Record<Language, any> = {
  uz: {
    ...
    apply: {
      ...
      programPreferences: "Dastur Tanlovlari",
      documents: "Hujjatlar",
      ...
      applicationSummary: "Ariza Xulosasi",
  ...
  ru: {
    ...
    apply: {
      ...
      programPreferences: "Предпочтения по Программам",
      documents: "Документы",
  ...
  en: {
    ...
    apply: {
      title: "Apply Now",
      subtitle: "Apply for study abroad programs at universities",
